...
import UserWeatherInfoCardDetails from "@/components/UserWeatherInfoCardDetails.vue";
...
<template>
  ...
  >
    <UserWeatherInfoCard :weather-info="weatherInfo" :showDetailBtn="false" />
    <UserWeatherInfoCardDetails :weather-info="weatherInfo" />
  </main>
</template>
